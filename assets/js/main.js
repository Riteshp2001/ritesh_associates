(function ($) {
    ...
    $(document).ready(function () {
        var navLinks = $("#offcanvasNav a");
        var navLinksMobile = $(".d-flex a");
        ...
        navLinksMobile.on("click", scrollToSection);
    });
...
var navLinks = document.querySelectorAll("#offcanvasNav a");
var navLinksMobile = document.querySelectorAll(".d-flex a");
...
for (var i = 0; i < navLinks.length; i++) {
    ...
    navLinksMobile[i].addEventListener("click", scrollToSection);
}
